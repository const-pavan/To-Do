...
import com.pansgami.to_do.Util.TraillingIconState
import com.pansgami.to_do.componets.DisplayAlertDialog
import com.pansgami.to_do.componets.priorityItem
import com.pansgami.to_do.data.modal.Priority
import com.pansgami.to_do.ui.theme.*
...
fun ListAppBarActions(
    ...
    DisplayAlertDialog(
        ...
        message = stringResource(id = R.string.delete_all_tasks_conformation),
...
fun DeleteAllAction(
    ...
    IconButton(
        ...
        Icon(painter = painterResource(id = R.drawable.ic_more_vert_24),
...
fun SearchAppBar(
    ...
    var traillingIconState by remember {
        mutableStateOf(TraillingIconState.READY_TO_DELETE)
    }
            ...
            trailingIcon = {
                IconButton(
                    onClick = {
                        ...
                        {
                            TraillingIconState.READY_TO_DELETE->{
                                onTextChange("")
                                traillingIconState=TraillingIconState.READY_TO_CLOSE
                            }
                            TraillingIconState.READY_TO_CLOSE->{
                                if(text.isNotEmpty())
                                {
                                    onTextChange("")
                                }
                                ...
                                {
                                    onCloseClicked()
                                    traillingIconState=TraillingIconState.READY_TO_DELETE
                                }
                            }
                        }
                    }
